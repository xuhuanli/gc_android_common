...
public interface OnItemMoveListener {
    ...
    /**
     * 滑动速度监听
     * @return > 0的时候 会拦截原先的滑动速度 改成return的速率
     */
    int onOutOfBoundsScroll(@NonNull RecyclerView recyclerView, int viewSize, int viewSizeOutOfBounds, int totalSize, long msSinceStartScroll);
}